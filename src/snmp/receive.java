...
public class receive extends javax.swing.JFrame {
    ...
    TrapReceiver receivetrap = new TrapReceiver();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(70, 70, 70)
                .addComponent(avoir, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(97, 97, 97)
    ...
    private void avoirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_avoirActionPerformed
        new Thread() {
            ...
            public synchronized void run() {
                try {
                    receivetrap.listen(new UdpAddress("localhost/162"));
                    System.out.println("oui " + receivetrap.type + receivetrap.b);
                    table.setText(receivetrap.type);
                    table.setText(table.getText() + receivetrap.b);
                } catch (IOException ex) {
                    Logger.getLogger(receive.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }.start();
//            receivetrap.processPdu(cmdRespEvent);
