...
{
    public java.util.Vector<VariableBinding> b;
    public String type;
  public TrapReceiver()
  {
  }
   ...
   */
  public synchronized String listen(TransportIpAddress address) throws IOException
  {
  ...
  public synchronized void processPdu(CommandResponderEvent cmdRespEvent)
  {
    ...
    if (pdu != null)
    {
      ...
      b = (Vector<VariableBinding>) pdu.getVariableBindings();
      type = String.valueOf(pdu.getType());
